...
const Footer = () => {
  return (
    <div className="grid grid-cols-3 gap-20 text-gray-200 bg-gray-900 px-8 py-12">
      <div className="md:col-span-1 col-span-3">
        <h1 className="text-2xl underline font-heading">About Us</h1>
        <br />
        <p>
          We are College Friends Pursuing B-Tech in Computer Science and
          Engineering. We have develped this Web Application to make it easier
          for students of the university to find good quality notes irrespective
          of their branch and semester
          <br />
          This build a strong Community where study material can be shared
          easily.
        </p>
      </div>
      <div className="col-span-3 md:col-span-2">
        <h1 className="text-2xl underline font-heading">Contact Us</h1>
        <br />
        <div className="grid grid-cols-2 text-gray-300 justify-center">
          <div className="">
            <span className="font-semibold text-xl">
              <p>Jatin Goyal</p>
              <br />
              <a href="https://www.linkedin.com/in/jatin-goyal-1469061aa/">
                <svg
              ...
              <a href="https://github.com/JatinGoyal123">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40px"
                  height="48"
          ...
          <div>
            <span className="font-semibold text-xl">
              <p className="ml-4">Vishesh Goyal</p>
              <br />
              <a href="https://www.linkedin.com/in/vishesh-goyal21/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 28.87 28.87"
                  width="40px"
              ...
              <a href="https://github.com/VisheshGoyal21">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40px"
                  height="48"
